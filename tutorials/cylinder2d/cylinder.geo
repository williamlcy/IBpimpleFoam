Point(1) = {0, 0, -0.5, 1};
//+
Point(2) = {0.707, 0.707, -0.5, 1.0};
//+
Point(3) = {-0.707, -0.707, -0.5, 1.0};
//+
Point(4) = {0.707, -0.707, -0.5, 1.0};
//+
Point(5) = {-0.707, 0.707, -0.5, 1.0};
//+
Point(6) = {0.3535, 0.3535, -0.5, 1.0};
//+
Point(7) = {-0.3535, -0.3535, -0.5, 1.0};
//+
Point(8) = {0.3535, -0.3535, -0.5, 1.0};
//+
Point(9) = {-0.3535, 0.3535, -0.5, 1.0};
...
//+
Extrude {0, 0, 1.0} {
  Surface{2}; Surface{5}; Surface{4}; Surface{1}; Surface{3}; Layers {1}; Recombine;
}
//+
